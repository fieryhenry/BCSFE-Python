...
class FeatureHandler:
    ...
    def get_features(self):
        ...
        features: dict[str, Any] = {
            ...
            "specials": {
                "xpα": edits.basic_items.BasicItems.edit_xp,
                "npα": edits.basic_items.BasicItems.edit_np,
                ...
                "general_ticketsα": edits.basic_items.BasicItems.edit_normal_tickets,
                "platinum_ticketsα": edits.basic_items.BasicItems.edit_platinum_tickets,
                "legend_ticketsα": edits.basic_items.BasicItems.edit_legend_tickets,
                "leadershipα": edits.basic_items.BasicItems.edit_leadership,
            },
            "items": {
