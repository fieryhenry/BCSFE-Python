...
class FeatureHandler:
    ...
    def get_features(self):
        ...
        features: dict[str, Any] = {
            ...
            "specials": {
                "xpα": edits.basic_items.BasicItems.edit_xpα,
                "npα": edits.basic_items.BasicItems.edit_npα,
                "catfoodα": edits.basic_items.BasicItems.edit_catfoodα,
                "battle_itemsα": edits.basic_items.BasicItems.edit_battle_itemsα,
                "cataminsα": edits.basic_items.BasicItems.edit_cataminsα,
                "base_materialsα": edits.basic_items.BasicItems.edit_base_materialsα,
                "catseyesα": edits.basic_items.BasicItems.edit_catseyesα,
                "catfruitα": edits.basic_items.BasicItems.edit_catfruitα,
                "talent_orbsα": core.game.catbase.talent_orbs.SaveOrbs.edit_talent_orbsα,
                "general_ticketsα": edits.basic_items.BasicItems.edit_general_ticketsα,
                ...
                "all_sol": core.game.map.event.EventChapters.edit_all_sol_chapters,
                "all_uncanny": core.game.map.uncanny.UncannyChapters.edit_all_uncanny,
                "all_zero_legends": core.game.map.zero_legends.ZeroLegendsChapters.edit_all_zero_legends,
                "all_aku_chapters": core.game.map.aku.AkuChapters.edit_all_aku_chapters,
                "all_event": core.game.map.event.EventChapters.edit_event_chapters,
                "all_collab": core.game.map.event.EventChapters.edit_collab_chapters,
                "all_gauntlets": core.game.map.gauntlets.GauntletChapters.edit_gauntlets,
                "all_collab_gauntlets": core.game.map.gauntlets.GauntletChapters.edit_collab_gauntlets,
                "all_towers": core.game.map.tower.TowerChapters.edit_towers,
